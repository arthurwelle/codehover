...
# codehover <img src="https://raw.githubusercontent.com/arthurwelle/codehover/master/HexSticker/HexSticker.png" align="right" width="250" />
...
Since version 2.0.0 the object returned by ``ch_out()`` is already renderable (its CSS and JavaScript are attached automatically) -- just print it.
